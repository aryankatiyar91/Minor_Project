...
<html>
    <head>
        <meta charset="utf-8">
        <title>किसानों की जानकारी</title>
    ...
    <nav class="navbar navbar-default">
        ...
        <div class="container">
            ...
            <a href="customer to farmers H.html"><button type="NEXT"class="btn btn-lg btn-success btn2">अगला</button></a>
            <a href="farmer data collect_h.php"><button type="NEXT"class="btn btn-lg btn-success btn1">वापस जाओ</button></a>
