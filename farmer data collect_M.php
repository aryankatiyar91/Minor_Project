...
<html>
    ...
    <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="farmers info M.php"><span class="glyphicon glyphicon-align-left"></span>शेतकर्‍यांचा तपशील</a></li>
                        <li><a href="customer to farmers M.html"><span class="glyphicon glyphicon-phone"></span>शेतकरी संपर्क</a></li>
                        <li><a href="help cim.html"><span class="glyphicon glyphicon-question-sign"></span>मदत</a></li>
        ...
        <div class="container-fluid">
            ...
            <a href="farmers info M.php"><button type="NEXT"class="btn btn-lg btn-success">पुढे</button></a>
