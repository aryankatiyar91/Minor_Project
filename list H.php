...
<html>
    <head>
        <meta charset="utf-8">
        <title>आपके पहले से जोड़े गए उत्पाद की सूची</title>
    ...
    <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="Message H.php"><span class="glyphicon glyphicon-flash"></span>संदेश</a></li>
        ...
        <h1>आपके पहले से जोड़े गए उत्पाद की सूची</h1>
